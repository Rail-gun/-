...
<div class="container">
  <div id="page">
    ...
    <tbody>
       ...
       out.print("<td><button onclick = \"window.location.href='tea_print?studentID="+list.get(i).getStudentID()+"'\" class='btn btn-default btn-primary' style=\"color: white; font-weight:bold;BACKGROUND-COLOR: #56a2cf;border-radius:4px;BORDER : 1px solid #56a2cf;width:60px;HEIGHT: 30px\" type=\"button\">打印<tton></td>");
       out.print("</tr>");
	     }
      %>
